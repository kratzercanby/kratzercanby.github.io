(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[47],{"08kA":function(e,n,t){"use strict"
...
return e}function _(e,n){var t=n.match(/\s*(.+)\s*=\s*"?([^"]+)"?/)
t&&(e[t[1]]=t[2])
return e}function i(e){try{var n=e.match(/<?([^>]*)>(.*)/),t=n[1],o=n[2].split(";"),c=r.parse(t),i=a.parse(c.query)
o.shift()
var d=o.reduce(_,{})
d=s(i,d)
d.url=t
return d}catch(e){return null}}e.exports=function(e){if(!e)return null
return e.split(/,\s*</).map(i).filter(o).reduce(c,{})}},"4Ogu":function(e,n,t){"use strict"
...
var _=t.n(c)
var i=t("etQE")
function d(e){let n=e.path,t=e.params
const a=s.a.param(t)
...
Object.assign(f,h)
const p=d({path:n,params:b})
const y=await fetch(p,Object(a["a"])({body:u,method:r},f))
if(!y.ok){const e=new Error("doFetchApi received a bad response: ".concat(y.status," ").concat(y.statusText))
e.response=y
throw e}const v=_()(y.headers.get("Link"))
const m=await y.text()
const j=m.length>0?JSON.parse(m):null
return{json:j,response:y,link:v}}},"6V2X":function(e,n,t){"use strict"
var a=t("An8g")
var r=t("Ff2n")
var s=t("pQTu")
var o=t("m0r6")
...
const l=Object(_["lazy"])(()=>Promise.all([t.e(6),t.e(5),t.e(8),t.e(23),t.e(102),t.e(141),t.e(577)]).then(t.bind(null,"mftS")))
...
return i.a.createElement(d["a"],Object.assign({label:c.t("Copy To..."),placement:"end",onDismiss:s,padding:"medium"},o),Object(a["a"])(l,{sourceCourseId:n,contentSelection:t,onCancel:s}))}},EUQ6:function(e,n,t){"use strict"
...
const y=Object(d["lazy"])(()=>Promise.all([t.e(6),t.e(5),t.e(8),t.e(23),t.e(565)]).then(t.bind(null,"FB/m")))
var v=Object(a["a"])(g["a"],{renderTitle:"",size:"x-small"})
function m(e){let n=e.contentShare,t=e.courseId,c=Object(o["a"])(e,["contentShare","courseId"])
const _=Object(d["useState"])([]),m=Object(s["a"])(_,2),j=m[0],k=m[1]
const S=Object(d["useState"])(null),O=Object(s["a"])(S,2),C=O[0],A=O[1]
const x=Object(d["useRef"])(c.open)
function E(){k([])
A(null)}function L(e){j.find(n=>n.id===e.id)||k(j.concat([e]))}function z(e){k(j.filter(n=>n.id!==e.id))}function T(){return Object(p["a"])({method:"POST",path:"/api/v1/users/self/content_shares",body:Object(r["a"])({},n,{receiver_ids:j.map(e=>e.id)})})}function I(){A("info")
T().then(()=>A("success")).catch(e=>{console.error(e)
e.response&&console.error(e.response)
A("error")})}function w(){return l.a.createElement(l.a.Fragment,null,Object(a["a"])(u["a"],{onClick:c.onDismiss},void 0,i.t("Cancel")),Object(a["a"])(u["a"],{disabled:0===j.length||null!==C,variant:"primary",margin:"0 0 0 x-small",onClick:I},void 0,i.t("Send")))}const R=Object(a["a"])(h["a"],{as:"div",textAlign:"center"},void 0,Object(a["a"])(g["a"],{renderTitle:i.t("Loading...")}))
if(c.open!==x.current){x.current=c.open
E()}let q=""
"info"===C?q=i.t("Starting content share"):"success"===C?q=i.t("Content share started successfully"):"error"===C&&(q=i.t("Error starting content share"))
const B=q?Object(a["a"])(b["a"],{variant:C},void 0,Object(a["a"])("div",{role:"alert","aria-live":"assertive","aria-atomic":true},void 0,q),"info"===C?v:null):null
return l.a.createElement(f["a"],Object.assign({label:i.t("Send To..."),size:"medium"},c,{footer:Object(a["a"])(w,{})}),Object(a["a"])(d["Suspense"],{fallback:R},void 0,B,Object(a["a"])(y,{courseId:t,selectedUsers:j,onUserSelected:L,onUserRemoved:z})))}},qBwj:function(e,n,t){"use strict"
var a=t("17x9")
var r=t("EUQ6")
...
Object(a["shape"])({id:a["string"].isRequired,name:a["string"].isRequired,content_type:Object(a["oneOf"])(i).isRequired,created_at:a["string"].isRequired,updated_at:a["string"].isRequired,read_state:a["string"].isRequired,sender:r["b"].isRequired,content_export:_})},xGaD:function(e,n,t){"use strict"
var a=t("An8g")
var r=t("Ff2n")
var s=t("pQTu")
var o=t("m0r6")
...
return i.a.createElement(d["a"],t,Object(a["a"])(_["Suspense"],{fallback:s},void 0,n))}}}])

//# sourceMappingURL=47-c-982f91ee48.js.map